package com.bank.islamic.murabahafinancing.model;
...
/**
 * The BIAN control record for this service domain: "Murabaha Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Murabaha Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Murabaha Facility Fulfillment Arrangement";
